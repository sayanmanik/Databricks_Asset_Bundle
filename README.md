...
The 'my_dab' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] my_dab_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/my_dab.job.yml). The schedule
...
8. Some useful databricks cli commands
    ```
   $ databricks auth login "https link"
   $ databricks auth  profiles
   $ databricks catalogs list --profile PROFILE_NAME
   $ databricks catalogs get assetbundles --profile PROFILE_NAME
